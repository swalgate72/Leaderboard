...
} from '../game.js?v=20260704b';
import { idbSave, idbLoad, idbMarkClean, idbClear, idbGetDirty } from '../db.js?v=20260704b';
  ...
  try {
    ...
    if (gameState?.tournamentId) {
      try {
        ...
        activeTournament     = null // tournament removed;
...
function renderLeaderboard() {
  ...
  const standings = []; // tournament mode removed
